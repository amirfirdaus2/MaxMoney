...
import com.mobile.app.maxmoney.Common.StandardProgressDialog;
import com.mobile.app.maxmoney.Common.Validation;
import com.mobile.app.maxmoney.Activity.Registeration.MainRegisterActivity;
                    ...
                    api.loginUser(
                            ...
                            new Callback<Response>() {
                                ...
                                public void failure(RetrofitError error) {
                                    mProgressDialog.dismiss();
                                    Toast.makeText(LoginActivity_old.this, error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }
                    );
                }
